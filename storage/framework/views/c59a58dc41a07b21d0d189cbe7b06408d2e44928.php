    ...
    <div class="row no-gutters mt-5">
      ...
      <div class="col-md-2 bg-dark mt-2 pr-3 pt-4 pb-5">
        <ul class="nav flex-column ml-3 mb-3">
          ...
          <li class="nav-item">
            <a class="nav-link text-white" href="<?php echo e(route('customer.index')); ?>"><i class="bi bi-person mr-2"></i> Customer</a>
            <hr class="bg-light" />
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="<?php echo e(route('menu.index')); ?>"><i class="bi bi-card-list mr-2"></i> Menu</a>
            <hr class="bg-light" />
          </li>
          <li class="nav-item">
      ...
      <!-- Akhir SideBar --><?php /**PATH C:\laravel\belajar-laravel\resources\views/layout/section/sidebar.blade.php ENDPATH**/ ?>