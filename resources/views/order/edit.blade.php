...
@section('content')
    ...
    <a href="/order/index" class="btn btn-secondary" title="back"></a>
                        ...
                        <div class="mb-3 menu-container">
                            ...
                            @foreach ($order->orderItem as $key => $orderItem)
                                <div class="input-group mb-1 menu">
                                    ...
                                    <input type="nuber" name="quantity[]" class="form-control" placeholder="Quantity" value="{{ $orderItem->quantity }}">
                                    @if ($key == 0)
